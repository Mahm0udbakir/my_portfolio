...
class AnimatedHomeShell extends StatefulWidget {
  final GoRouterState? state;
  const AnimatedHomeShell({super.key, this.state});

  static const double maxOffsetFraction = 0.7;

  @override
  State<AnimatedHomeShell> createState() => _AnimatedHomeShellState();
}

class _AnimatedHomeShellState extends State<AnimatedHomeShell>
  ...
  Widget build(BuildContext context) {
    ...
    final maxOffset =
        MediaQuery.of(context).size.width * AnimatedHomeShell.maxOffsetFraction;
